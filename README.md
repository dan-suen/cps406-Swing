...
Hit Ctrl+Shift+B to build, Ctrl+Shift+T to run
The Swing GUI is visible to everyone via the port 6080 browser tab — share that URL in your Live Share chat