...
**From VS Code:**
- Press `F5` or go to **Run → Start Debugging** — uses the `Launch Scrum Tool` configuration in `.vscode/launch.json`
- Alternatively, right-click Main.java file and click "Run Project Without Debugging"
